                       ...
                       stepProposals, tol1, tol2, print, nfolds, nsimulations)
{
  ...
  bigsol <- .Call("Density_Estimation", data, FEMbasis$mesh, FEMbasis$order, mydim, ndim, fvec, heatStep, heatIter, lambda,
                  nfolds, nsimulations, stepProposals, tol1, tol2, print, step_method, direction_method, preprocess_method,
                  PACKAGE = "fdaPDE")
                                ...
                                stepProposals, tol1, tol2, print, nfolds, nsimulations)
{
  ...
  bigsol <- .Call("Density_Estimation", data, FEMbasis$mesh, FEMbasis$order, mydim, ndim, fvec, heatStep, heatIter,
                  lambda, nfolds, nsimulations, stepProposals, tol1, tol2, print, step_method, direction_method, preprocess_method,
                  PACKAGE = "fdaPDE")

...
#' tol1=1e-4, tol2=0, print=FALSE, nfolds=NULL, nsimulations=500, 
...
FEM.density <- function(data, FEMbasis, lambda, fvec=NULL, heatStep=0.1, heatIter=500, stepProposals=NULL,
                        ...
                        direction_method, preprocess_method="NoCrossValidation") 
{ 
  ...
  checkParametersDE(data, FEMbasis, lambda, step_method, direction_method, preprocess_method, tol1, tol2, nfolds, nsimulations, heatStep, heatIter) 
  ...
  if(class(FEMbasis$mesh) == 'mesh.2D'){	  
    ...
    bigsol = CPP_FEM.DE(data, FEMbasis, lambda, fvec, heatStep, heatIter, ndim, mydim, step_method, direction_method, preprocess_method,
                        stepProposals, tol1, tol2, print, nfolds, nsimulations)
